...
<table class='table table-bordered table-hover table-condensed'><legend><h3>Récapitulatif des <u><b>DEMANDES</b></u></b></h3></legend>
	...
	echo "<tr> <th style='text-align:center; vertical-align:middle;'> DATE </th> <th style='text-align:center; vertical-align:middle;'> CLIENT </th> <th style='text-align:center; vertical-align:middle;'>MATERIEL</th> <th style='text-align:center; vertical-align:middle;'> INTERVENTION </th> <th style='text-align:center; vertical-align:middle;'>OBSERVATIONS</th> <th style='text-align:center; vertical-align:middle;'>SAUVEGARDE<br />DOCUMENTS CLIENTS</th> <th colspan='3'  style='text-align:center; vertical-align:middle;'><center>ADMINISTRATION</center></th> </tr>";
		while ( ($preInterv = mysql_fetch_array($query1)) )
		{
			...
			echo "<td style='text-align:center; vertical-align:middle;'><form action='index.php?p=interv-preinterv' method='POST'> <input type='hidden' name='id' value='".$preInterv["id"]."' /> <input type='hidden' name='codeClient' value='" . $preInterv["codeClient"] . "'> <button class='btn btn-success'>Effectuer l'intervention</button> </form></td>
			<td style='text-align:center; vertical-align:middle;'><form action='preintervention/print_preinterv.php' method='POST'> <input type='hidden' name='id' value='" . $preInterv["id"] . "'> <input type='hidden' name='codeClient' value='" . $codeClient . "'> <button class='btn btn-info'>Imprimer</button> </form></td>
