...
function listing_clients($lettre) {
	if (!empty($_POST) ) { 
		$sql_liste = mysql_query("SELECT * FROM tclients WHERE nom LIKE '$lettre%' ORDER BY nom ASC ;") or  die ( mysql_error() ) ;

		while ( $ligne = mysql_fetch_array($sql_liste) )
		{ ?>
